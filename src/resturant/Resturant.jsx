...
const Resturant = () => {
  ...
  <div className="card-body">
    ...
    <button className="px-6 py-2 text-purple-100 rounded bg-gradient-to-r from-indigo-800 to-indigo-500 shadow:md mt-2">Explore</button>
            ...
            <div className="card w-96 bg-base-100 shadow-xl bg-gradient-to-r from-indigo-400 to-indigo-300">
  <figure><img src="https://img.freepik.com/free-photo/restaurant-hall-with-red-brick-walls-wooden-tables-pipes-ceiling_140725-8504.jpg?w=740&t=st=1683110860~exp=1683111460~hmac=208dbbb43761384d3db8c5d1256ea34fcbc622f341f43a3cf27190cd5313ac55" alt="Shoes" /></figure>
  <div className="card-body">
    <h2 className="card-title">
  ...
  <div className="card-body">
    ...
    <button className="px-6 py-2 text-purple-100 rounded bg-gradient-to-r from-indigo-800 to-indigo-500 shadow:md mt-2">Explore</button>
            ...
            <div className="card w-96 bg-base-100 shadow-xl bg-gradient-to-r from-indigo-400 to-indigo-300">
  <figure><img src="https://img.freepik.com/free-photo/group-friends-eating-restaurant_23-2148006644.jpg?w=740&t=st=1683110991~exp=1683111591~hmac=b792b699e6f8f461fdb026abc0252ac286dc966c791efc58bc0a514cca00beab" alt="Shoes" /></figure>
  <div className="card-body">
    <h2 className="card-title">
    Sushi Samurai
      <div className="badge badge-secondary">5 Star</div>
  ...
  <div className="card-body">
    ...
    <button className="px-6 py-2 text-purple-100 rounded bg-gradient-to-r from-indigo-800 to-indigo-500 shadow:md mt-2">Explore</button>
            ...
            <div className="card w-96 bg-base-100 shadow-xl bg-gradient-to-r from-indigo-400 to-indigo-300">
  <figure><img src="https://img.freepik.com/free-photo/restaurant-interior_1127-3392.jpg?w=740&t=st=1683111083~exp=1683111683~hmac=a111c4df9ce7c20aa30d9670f43289d89c97afc3f0290185a9b35797c98819fe" alt="Shoes" /></figure>
  <div className="card-body">
    <h2 className="card-title">
