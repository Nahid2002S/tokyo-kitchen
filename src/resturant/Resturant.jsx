...
const Resturant = () => {
    return (
        <div className='px-2'>
         ...
         <div className='grid w-full mx-auto lg:grid-cols-3 lg:px-12 px-2 gap-8 justify-center object-cover'>
         <div className="card w-88 bg-base-100 shadow-xl bg-gradient-to-r from-indigo-400 to-indigo-300">
