...
const Banner = () => {
    return (
        <div>
            ...
            <div>
                <h1 className='text-7xl mb-6 font-extrabold text-transparent bg-clip-text bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-pink-400 to-indigo-900'>TOKYO KITCHEN</h1>
