...
const ErrorPage = () => {
    return (
      ...
      <Link to="/">
      <button className="cursor-pointer px-4 py-2 rounded-md text-white font-semibold bg-gradient-to-r from-blue-600 to-blue-500 border-0 flex justify-center mx-auto">Back To Homepage</button>
      </Link>
       </div>
    </div>
    );
